...
<style>
    ...
    /* Info Button */
    .info-btn {
        background: linear-gradient(45deg, #FF007A, #7928CA, #00D4FF);
...
st.sidebar.markdown(
    '<a href="https://tr.wikipedia.org/wiki/Jeomanyetik_f%C4%B1rt%C4%B1na" target="_blank" class="info-btn">'
    '🌌 Güneş Fırtınaları ve Etkileri Hakkında Bilgi Al</a>',
    unsafe_allow_html=True
)
